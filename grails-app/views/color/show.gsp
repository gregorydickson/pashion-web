...
<html>
    ...
    <body>
        ...
        <div id="show-color" class="content scaffold-show" role="main">
            ...
            <f:display bean="color" />
            <g:form resource="${this.color}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.color}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
