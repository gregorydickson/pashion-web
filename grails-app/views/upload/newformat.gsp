...
<html>
    ...
    <form enctype="multipart/form-data" action="${createLink(action: 'upload2')}"
          class="dropzone" id="my-awesome-dropzone" method="post">
        <h1> NEW FORMAT - For uploading Look CSV Files</h1>
        <h1> City is the city of the show for the Looks</h1>
        <select name="city">
