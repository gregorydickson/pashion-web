...
<html>
    ...
    <body>
        <a href="#edit-permission" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-permission" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.permission}" method="PUT">
                <g:hiddenField name="version" value="${this.permission?.version}" />
                <fieldset class="form">
                    <f:all bean="permission"/>
                </fieldset>
