...
<html>
    ...
    <body>
        ...
        <div id="show-brand" class="content scaffold-show" role="main">
            ...
            <f:display bean="brand" />
            <g:form resource="${this.brand}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.brand}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
