...
<html>
    ...
    <body>
        ...
        <div id="show-connection" class="content scaffold-show" role="main">
            ...
            <f:display bean="connection" />
            <g:form resource="${this.connection}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.connection}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
